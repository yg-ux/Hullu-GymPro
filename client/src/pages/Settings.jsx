  ...
  return (
    <div className="card p-6 space-y-5">
      ...
      <p className="text-sm text-gray-500 -mt-1">
        Packages appear as quick-select buttons on the Add Member form — staff click one to fill in the membership type and price instantly. Use the toggle to hide a package without deleting it.
      </p>
