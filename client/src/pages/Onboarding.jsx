  ...
  return (
    <div className="min-h-screen bg-dark-200 flex flex-col items-center justify-center p-4">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-1/3 left-1/2 -translate-x-1/2 w-[800px] h-[500px]
      ...
      <div className="relative w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-2">
            ...
            <span className="text-xl font-bold text-white">Hullu Gyms</span>
          </div>
        </div>
        ...
        {/* Card */}
        <div className="bg-dark-100 border border-white/8 rounded-2xl p-8 shadow-2xl">
          ...
          {step === 1 && (
            <div className="space-y-6 animate-fade-in">
              ...
              <button
                onClick={next}
                className="w-full py-3 rounded-xl bg-gym-500 hover:bg-gym-600
                           text-white font-semibold flex items-center justify-center gap-2
                           transition-all hover:shadow-lg hover:shadow-gym-500/25"
              >
            ...
            <div className="space-y-5 animate-fade-in">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg bg-dark-300 border border-white/10
                             text-white placeholder-gray-500 focus:outline-none focus:ring-2
                             focus:ring-gym-500/50 text-sm"
              ...
              <div className="flex gap-3 pt-1">
                ...
                <button
                  onClick={saveProfile}
                  disabled={saving}
                  className="flex-1 py-2.5 rounded-xl bg-gym-500 hover:bg-gym-600
                             text-white font-semibold flex items-center justify-center gap-2
                ...
                {[
                  ...
                  >
                    <span className="flex items-center gap-2.5 text-sm text-gray-300
                      ...
                      <Icon className="w-4 h-4 text-gym-400" />
                      {text}
                    </span>
