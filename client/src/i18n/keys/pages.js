...
export const pages = {
  en: {
    ...
    'subscription.feature.customerMgmt':        'Member profiles with photo & payment history',
    'subscription.feature.attendance':          'Attendance tracking & visit history',
    'subscription.feature.checkInOut':          'Manual check-in & check-out with live gym view',
    'subscription.feature.basicDashboard':      'Dashboard showing today\'s activity & revenue',
    ...
    'subscription.feature.sms':                 'Automated SMS — welcome, payment & expiry alerts',
    'subscription.feature.staffAccounts':       'Up to 3 staff logins (receptionist, trainer, manager)',
    'subscription.feature.reports':             'Attendance analytics — visit trends & peak hours',
    'subscription.feature.expenseTracking':     'Monthly expense & recurring bill tracking',
    'subscription.feature.pricingPackages':     'Pricing packages for faster member registration',
    // Plan features — Pro
    'subscription.feature.unlimited':           'Unlimited members',
    'subscription.feature.everythingStarter':   'Everything in Starter',
    'subscription.feature.revenueAnalytics':    'Revenue analytics — income, plan breakdown & trends',
    'subscription.feature.retentionInsights':   'Retention insights — spot members at risk of leaving',
    'subscription.feature.equipmentMgmt':       'Equipment tracker — maintenance dates & condition logs',
    'subscription.feature.csvExport':           'CSV export & detailed reports for any date range',
